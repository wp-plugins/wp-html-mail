				...
				<div style="" class="inside">
					<table class="form-table">
						<tbody>
							...
							<tr valign="top">
								<th scope="row"><label for="haet_mailfromaddress"><?php _e('Email sender adress','haet_mail'); ?></label></th>
								<td>
		...
		<?php case 'plugins':?>
			<div class="postbox">
				...
				<div style="" class="inside">
					<table class="form-table">
						<tbody>
							<?php foreach ($active_plugins as $plugin_name => $plugin): ?>
							    <tr valign="top">
							    	<th scope="row"><label><?php echo $plugin['display_name']; ?></label></th>
							    	<td>
							    		...
							    		<label for="haet_mail_plugins_<?php echo $plugin_name; ?>_template"><?php _e('Use template','haet_mail'); ?></label>&nbsp;&nbsp;&nbsp;
